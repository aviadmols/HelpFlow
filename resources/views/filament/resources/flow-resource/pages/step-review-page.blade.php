<x-filament-panels::page>
        ...
        x-data="{
            ...
            async startConversation() {
                ...
                try {
                    ...
                    this.activeFlowName = data.flow_name || this.flowName;
    ...
    >
        <div class="rounded-lg bg-white dark:bg-gray-800 p-4 shadow">
            <h3 class="font-semibold text-lg mb-3">Review step: {{ $stepKey }}</h3>
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between flex-wrap gap-2">
                    <div>
                        ...
                        <p x-show="activeFlowName || flowKey" class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                            Reviewing step: <span x-text="stepKey"></span> — Flow: <span x-text="activeFlowName || flowName || '—'"></span> (<span x-text="flowKey || '—'"></span>)
                        </p>
                    </div>
                    <a
